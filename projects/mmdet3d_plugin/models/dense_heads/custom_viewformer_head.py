...
from projects.mmdet3d_plugin.models.dense_heads.viewformer_head import ViewFormerHead, Space3DNet
...
class CustomViewFormerHead(ViewFormerHead):
    """Head of ViewFormer. 
    Args:
    ...
    def __init__(self,
        ...
        self.space3D_net = CustomSpace3DNet(**space3D_net_cfg)
    ...
    def forward(self,
        ...
        uni_feats = self.space3D_net(space_query[-1], bev_only=bev_only)
...
class CustomSpace3DNet(nn.Module):
    def __init__(self,
                 in_channels,
                 feat_channels=32,
                 bev_dim=126,
                 ...
                 with_bev_vel=False,
                 pc_range=None):
        super(CustomSpace3DNet, self).__init__()
